...
| Archivo | Cuándo |
|---|---|
| `NaviaXP-<version>-universal-release.apk` | **El que quieres.** Funciona en cualquier teléfono |
...
2. Si es la primera vez, Android te pedirá permitir instalaciones desde el
   navegador o el explorador de archivos. Es normal fuera de la tienda.
3. Al abrir la app, dale permiso de acceso a archivos: lo necesita para leer
   las carpetas de tus juegos.
4. Pulsa **Agregar juego** y elige la carpeta que contiene `Game.ini`.

### "No se verificó esta app"

Google avisa de cualquier app que no venga de su tienda y que todavía no haya
analizado. Puedes tocar **Enviar app** para que la revise, o continuar.

Si quieres comprobar que el archivo es el nuestro y nadie lo ha tocado, cada
versión publica su SHA-256 en las notas, y todas van firmadas con el mismo
certificado:
